...
namespace Course3
{
    public partial class sign_up : Form
    {
        ...
        private void buttonEnter_Click(object sender, EventArgs e)
        {
            ...
            string querystring = $"insert into registr(login_user,password_user) values('{loginuser}','{passworduser}')";
        ...
        private Boolean checkuser()
        {
            ...
            string querystring = $"select id_user,login_user,password_user from registr where login_user = '{loginUser}' and password_user = '{passUser}'";
