...
namespace Course3
{
    public partial class log_in : Form
    {
        ...
        private void buttonEnter_Click(object sender, EventArgs e)
        {
            ...
            // создаем экз класса адаптер и тэйбл (нужны для того чтобы занести значения с клаиватуры в таблицу в базе данных)
            SqlDataAdapter adapter = new SqlDataAdapter();
            DataTable table = new DataTable();
            // проверяем есть ли в таблице есть строки со значениями текстбоксов
            string querystring = $"select id_user,login_user,password_user from registr where login_user = '{loginuser}' and password_user = '{passworduser}'";
